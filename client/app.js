...
class App extends React.Component {
  ...
  placeBet() {
    ...
    if (currentBet > this.state.chips) {
      ...
      const chips = this.state.chips - currentBet
      this.setState({chips, inputValue: '', currentBet})
    }
  }
    ...
    if (!this.state.gameOver) {
      ...
      if (dealer.count > 21) {
        this.setState({
          deck,
          dealer,
          chips: this.state.chips + this.state.currentBet * 2,
          gameOver: true,
        ...
        if (winner === 'dealer') {
          ...
          chips += this.state.currentBet * 2
          message = 'You win!'
        } else {
          chips += this.state.currentBet
          message = 'Push.'
        }
